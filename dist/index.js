...
async function build() {
    ...
    await (0, execa_1.commandSync)(`curl https://download.swift.org/experimental-use-only/repo/amazonlinux/releases/2/swiftlang.repo > /etc/yum.repos.d/swiftlang.repo`);
